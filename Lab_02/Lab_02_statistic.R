...
#### LABORATÓRIO 02: Teste de Shapiro-Wilk, Teste F e Teste t ####

# Objetivo neste estudo é responder a seguinte pergunta: “Existe diferença significativa na média de sono dos
# 2 grupos de pacientes, ou seja, há diferença significativa entre os dois medicamentos que ajudam no distúrbio do sono?”

#### 1. Working Directory ####
# Configurando o diretório de trabalho
setwd("C:/Users/Utilizador/repos/Formacao_cientista_de_dados/big_data_analytics_R_microsoft_azure_machine_learning/Modulo_09")
getwd()
