...
#### LABORATÓRIO 05: O Que Fazer Quando a Suposição do Teste Estatístico Não é Satisfeita? ####

# Objetivo neste estudo é responder a seguinte pergunta: 
# Há diferença significativa no crescimento dos dentes de acordo com o tipo de suplemento usado nos Porcos da Guiné?

#### 1. Working Directory ####
# Configurando o diretório de trabalho
setwd("C:/Users/Utilizador/repos/Formacao_cientista_de_dados/big_data_analytics_R_microsoft_azure_machine_learning/Modulo_12")
getwd()
