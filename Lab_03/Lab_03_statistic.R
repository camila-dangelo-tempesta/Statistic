...
#### LABORATÓRIO 03: Dashboard com Shiny Para Automação de Testes Estatísticos ####

#### 1. Working Directory ####
# Configurando o diretório de trabalho
setwd("C:/Users/Utilizador/repos/Formacao_cientista_de_dados/big_data_analytics_R_microsoft_azure_machine_learning/Modulo_10")
getwd()
...
#### 6. Amostragem ####
  ...
  #### 7. Tabela de resultado do teste ####
